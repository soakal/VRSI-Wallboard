...
- Current: `v0.9.2` — tagged and released on GitHub (2026-06-11, zip asset uploaded). Adds "👤 All users" to the Projects board picker (BoardHeader) matching the calendar; carries the v0.9.1 installer permission fix. Kiosk is on v0.9.0 — update via the button to pick this up.
