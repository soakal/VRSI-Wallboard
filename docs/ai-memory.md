...
- Last completed task: v0.5.1 — AgendaRail shows next 14 days grouped by day (was today+tomorrow only → permanently empty since ship dates rarely land in that window). Before that: v0.5.0 Files toggle; v0.4.0 calendar user picker + per-user agenda + NEW badges + New filter; v0.3.0 multiple super users; v0.2.0 conhost --headless tray launcher.
...
- Current: `v0.5.1` — tagged and released on GitHub (2026-06-10)
...
App is v0.5.1. `VRSI WallBoard\` folder is distribution-ready.
