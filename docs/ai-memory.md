...
- Current: `v0.14.1` — Tier-1 robustness: migration parse guards, global crash handlers, DB integrity_check + WAL checkpoint, pre-restore retention 3→5, version sync (client was 1.0.0). All three packages now 0.14.1.
