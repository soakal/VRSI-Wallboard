...
- Current: `v0.9.1` — tagged and released on GitHub (2026-06-11, zip asset uploaded). Ships the installer permission fix (`Install-WallBoard.ps1` icacls Modify grant for the kiosk user) so the in-app Update button works without elevation on fresh installs. No app/UI changes vs 0.9.0.
