...
- Current: `v0.10.0` — new/changed-note flagging (hasNewNote) + Blocked tab (manual triage lane). Council-reviewed, 20/20 verified. Root + server bumped to 0.10.0.
