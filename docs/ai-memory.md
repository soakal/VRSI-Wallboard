...
- Current: `v0.12.0` — 2-week calendar view (subclasses RBC MonthView; verified against running app). Calendar plan fully complete. Root + server bumped to 0.12.0.
