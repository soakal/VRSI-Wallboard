...
- Current: `v0.14.0` — hardening + diagnosability: fixed XLSX.SSF numeric-date crash, +12 parser unit tests (21 total), CI workflow, log rotation + download-logs button, version in Monitoring header, weak-secret warning. Root + server bumped to 0.14.0.
