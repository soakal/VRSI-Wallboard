...
- Current: `v0.11.0` — calendar month-cell cutoff fix + week-label date range + first unit-test suite (board logic). 2-week view deferred (needs spike). Root + server bumped to 0.11.0.
